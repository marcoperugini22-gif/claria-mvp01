...
export function ChatWidget() {
  ...
  return (
    <>
      {/* Floating button — bottom-6 su mobile e desktop */}
      <div className="fixed bottom-6 left-1/2 -translate-x-1/2 w-full max-w-md md:pl-[72px] px-5 z-50 flex justify-end pointer-events-none">
        <button
          type="button"
          onClick={() => setOpen((v) => !v)}
